...
with tab1:
    ...
    with col2:
        st.markdown("[SLAC 2009, Page 5-7 of 9](https://nasa.sharepoint.com/:b:/r/teams/IHTeam/Shared%20Documents/ODH%20and%20LEL%20Analysis/Failure%20%20Release%20Rates/SLAC%20Feb%202009.pdf?csf=1&web=1&e=BdjqiF)")
    ...
    with col6:
        st.markdown("[Roymech, Page 1-2 of 2](https://nasa.sharepoint.com/:b:/r/teams/IHTeam/Shared%20Documents/ODH%20and%20LEL%20Analysis/Failure%20Rates%20Roymech.co.uk.pdf?csf=1&web=1&e=6Ri7zP)")
...
with tab2:
    ...
    with col4:
        st.markdown("[Kunkle Model 30, Page 2](https://lqms.gsfc.nasa.gov/lqms-media/pvs/compfile/RV-Kunkle-_Model_30.pdf)")
    ...
    files = [
        ...
        "Kingston Model 119:118.csv", "Kingston Model KSV12 &KSV25.csv", "Kunkle Models 6933, 6934, 6935.csv"
    ]
